...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        carService.add(new Car("LADA", "1"));
        carService.add(new Car("LADA", "3"));
        carService.add(new Car("LADA", "5"));
        carService.add(new Car("LADA", "6"));
        ...
        System.out.println(userService.findOwner("LADA", "3"));
        context.close();
    }
}